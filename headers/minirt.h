...
int				ft_intersect_sphere(t_ray *ray,
				t_object *object, double *solution);
int				ft_intersect_cylinder(t_ray *ray,
				t_object *object, double *solution);
int				ft_intersect_plane(t_ray *ray,
				t_object *object, double *solution);
int				ft_intersect_square(t_ray *ray,
				t_object *object, double *solution);
int				ft_intersect_triangle(t_ray *ray,
				t_object *object, double *solution);
...
t_object		ft_mksquare(t_coords pos,
				t_coords ori, double height, int color);
t_object		ft_mkcylinder(t_coords pos,
				t_coords ori, double hr[2], int color);
...
void			ft_shade_sphere(t_surf_pt *p_hit,
				t_object *obj, t_light *light);
void			ft_shade_flatsurf(t_surf_pt *p_hit,
				t_object *obj, t_light *light);
void			ft_shade_cylinder(t_surf_pt *p_hit,
				t_object *obj, t_light *light);
void			ft_shade_color(t_surf_pt *p_hit,
				int color, t_light *light, double facing_ratio);
void			ft_shade_amblight(t_surf_pt *p_hit,
				t_object *obj, t_light *amblight);
